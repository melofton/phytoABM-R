...
2.  Movement of individuals given static water temp profile using turbulence/diffusion equation
    ...
    3.  Add necessary environmental conditions/traits to environmental dataframe and inds, respectively
        ...
        1.  need to calculate dynamic (absolute) viscosity of water; use Kestin et al. 1978
    ...
    10. Modifications following Hassan + RoL team feedback (16MAR24)

        1.  Reduce to one group that is vaguely green algae (round, 20um diameter, 1050 density)

        2.  Get rid of Stokes equation and use fixed sinking rate

        3.  Run for multiple days where each day is exactly the same
