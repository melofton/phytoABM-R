...
jpeg("./HABs-ABM/temp_eq_EFI.jpeg", res = 300, width = 5, height = 3.5, units = "in")
par(cex.lab = 1.5, mgp = c(2.7,1,0))
curve(f2(x,Tmin=Tmin,Topt=Topt,Tmax=Tmax),from=4, to=35,ylab='Photosynthesis rate',xlab = 'Water temperature (°C)')
dev.off()
